#!/usr/bin/env python3
"""Extract Wan VAE latents and empty text embedding for a local UR10 LeRobot dataset."""
...
DEFAULT_DATASET_ROOT = Path("/home/syr/code/outputs/ur10_gamepad_tcp_10hz_drawer_block_trainready_20260412")
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Extract Wan VAE latents and empty_emb.pt for a LeRobot-formatted UR10 dataset."
    )
...
def resolve_model_path(model_path: Path | None) -> Path:
    if model_path is not None:
        ...
        if not env_value:
            env_value = "/mnt/sda/syr/models/lingbot-va-posttrain-robotwin"
